...
native_ts_store_irregular <- function(dss, pathname, startDateBase, times, timeGranularitySeconds, values, quality, saveAsFloat, units, type, timeZoneName, storageFlag) {
    .Call(`_hecdssr_native_ts_store_irregular`, dss, pathname, startDateBase, times, timeGranularitySeconds, values, quality, saveAsFloat, units, type, timeZoneName, storageFlag)
}
