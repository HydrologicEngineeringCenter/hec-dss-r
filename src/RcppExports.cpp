...
int native_ts_store_irregular(DssPtr dss, const std::string& pathname, const std::string& startDateBase, Rcpp::IntegerVector times, int timeGranularitySeconds, Rcpp::NumericVector values, Rcpp::IntegerVector quality, int saveAsFloat, const std::string& units, const std::string& type, const std::string& timeZoneName, int storageFlag);
RcppExport SEXP _hecdssr_native_ts_store_irregular(SEXP dssSEXP, SEXP pathnameSEXP, SEXP startDateBaseSEXP, SEXP timesSEXP, SEXP timeGranularitySecondsSEXP, SEXP valuesSEXP, SEXP qualitySEXP, SEXP saveAsFloatSEXP, SEXP unitsSEXP, SEXP typeSEXP, SEXP timeZoneNameSEXP, SEXP storageFlagSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< DssPtr >::type dss(dssSEXP);
    ...
    Rcpp::traits::input_parameter< const std::string& >::type timeZoneName(timeZoneNameSEXP);
    Rcpp::traits::input_parameter< int >::type storageFlag(storageFlagSEXP);
    rcpp_result_gen = Rcpp::wrap(native_ts_store_irregular(dss, pathname, startDateBase, times, timeGranularitySeconds, values, quality, saveAsFloat, units, type, timeZoneName, storageFlag));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_hecdssr_native_ts_store_irregular", (DL_FUNC) &_hecdssr_native_ts_store_irregular, 12},
